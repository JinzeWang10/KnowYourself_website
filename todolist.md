...
心理年龄测试最后不需要展示多少分数，在原本分数的位置告诉用户心理年龄是多少岁就行。

sharecard 的 padding 在哪里调，现在有点小

心理年龄测试的“维度得分详情”可以增加一些对维度的简单解析或者不同分数段的简单评价。请认真分析

现在维度分析雷达图，有的维度名称无法显示完全。适当调小分享卡片中的维度分析雷达图的大小。
