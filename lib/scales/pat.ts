...
export const pat: QuizTemplate = {
    ...
    ranges: [
      {
        ...
        max: 200,
        level: '极高成熟度',
        description: '你心理极为成熟，能理智应对复杂情绪与人际关系。决策稳重、自省力强。',
        suggestion: '保持成长，但注意别过度理性、忽略感性与放松。',
        psychologicalAge: '实际年龄 +10 岁以上',
      },
      {
        min: 140,
        max: 169,
        level: '高成熟度',
        description: '你具备良好的自我控制和责任感。能在压力中保持平衡。',
        suggestion: '适度表达情感，避免"过于懂事"而压抑自己。',
        psychologicalAge: '实际年龄 +5 ～ 10 岁',
      },
      {
        min: 110,
        max: 139,
        level: '中等成熟度',
        description: '你的心理发展与年龄相符。具备一定独立与反思力。',
        suggestion: '尝试更深层地了解情绪、需求与人际连接。',
        psychologicalAge: '实际年龄 ±3 岁',
      },
      {
        min: 80,
        max: 109,
        level: '发展中阶段',
        description: '你仍在成长中，可能在自我管理或人际处理上不够稳。',
        suggestion: '练习情绪觉察，学习沟通与自我反思技巧。',
        psychologicalAge: '实际年龄 −5 ～ 10 岁',
      },
      {
        min: 40,
        max: 79,
        level: '心理发展滞后',
        description: '你可能仍处于心理依赖或回避成长阶段。',
        suggestion: '从小目标开始，培养自我责任感与独立意识，必要时寻求心理咨询支持。',
        psychologicalAge: '实际年龄 −10 岁以上',
      },
    ],
  },
  ...
  references: [
    'Greenberger, E., & Sorensen, A. (1974). Toward a concept of psychological maturity in adolescence. Journal of Youth and Adolescence, 3(4), 329–358.',
    ...
    'Kernberg, O. F. (2004). Object-Relations Theory and Clinical Psychoanalysis. Yale University Press.',
    'Goleman, D. (1995). Emotional Intelligence: Why It Can Matter More Than IQ. Bantam Books.',
  ],

  disclaimer: '本测试仅用于自我认知与心理成长参考，非临床诊断工具。心理年龄并非固定，可随生活经历与反思持续变化。若持续感到情绪失衡或关系困扰，建议咨询专业心理师。',
};
