        ...
        <div className="relative" style={{ padding: '8px' }}>
          ...
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                {/* 移除渐变效果，使用纯色 */}
                <div className="font-bold text-xl text-purple-600">KnowYourself</div>
          ...
          <div className={`relative bg-gradient-to-br ${palaceColorScheme.bgGradient} rounded-3xl overflow-hidden mb-8`} style={{ padding: '16px' }}>
            ...
            <div className="flex flex-col items-center relative z-10">
              ...
              <div className="text-center mb-6">
                <h3 className="text-5xl font-black text-purple-600 mb-3">
                  {mainCharacter.name}
                </h3>
              </div>

              {/* 核心特质描述 - 修复：移除backdrop-blur */}
              <div className="bg-white rounded-2xl shadow-soft border border-amber-200/50 mb-6" style={{
                padding: '18px 16px',
                maxWidth: '100%',
                width: '100%'
              }}>
          ...
          <div className="flex items-center justify-between border-t-2 border-amber-200/30" style={{ paddingTop: '12px', gap: '12px' }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm">
                {/* 修复：使用纯色而非渐变文字 */}
                <div className="font-black text-neutral-900 text-lg text-purple-600">
                  KnowYourself
                </div>
